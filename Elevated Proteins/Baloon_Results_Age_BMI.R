...
dframe1 <- read.csv(file = paste0('/Users/marcelo_palermo/Doutorado/R/Olink/NextSteps/Results/Results_Age_BMI_',split_factor_file,'.csv'))

p<- ggballoonplot(
  dframe1, x = "Bname", y = "Measure",
